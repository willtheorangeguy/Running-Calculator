...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Running Calculator.
...
**Personal data is only recorded locally on the computer, and never sent to our servers.**
