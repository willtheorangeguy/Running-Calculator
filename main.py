...
def main():
    ...
    while run == True:
        ...
        while length_run == True:
            ...
            if length_type.lower() == "marathons" or length_type.lower(
            ) == "marathon":
                unit = "marathon"
                ...
                length_run = False
            elif length_type.lower() == "miles" or length_type.lower(
            ) == "mile":
                unit = "miles"
                print("You are now entering in miles! \n")
                length_run = False
            elif length_type.lower() == "feet" or length_type.lower(
            ) == "foot":
                unit = "feet"
                ...
                length_run = False
            elif length_type.lower() == "meters" or length_type.lower(
            ) == "meter":
                unit = "meters"
                ...
                print(
                    "Running Calculator Copyright (C) 2022-2023 @willtheorangeguy"
                )
                print(
                ...
                print(
                    "under certain conditions; view the license for details. \n"
                )
                length_run = True
        ...
        while time_run == True:
            try:  # enable only numerical values
                ...
                hours = int(
                    input(
                        "How many hours did it take you? (if < 1, enter 0) "))
                mins = int(
                    input(
                        "How many minutes did it take you? (if < 1, enter 0) ")
                )
        ...
        print("Your speed was " + str(round(metersps, 2)) +
              " meters per second or " + str(round(kmph, 2)) +
              " kilometers per hour. \n\n")
